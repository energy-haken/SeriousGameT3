...
- Développer et expliquer un peu plus les informations.
- La partie simulation n'est pas très explicite.
- Lire la partie interface ne suffit pas à comprendre à quoi ressemble l'interface.

# Propositions d'amélioration du jeu

- Ajout d'un onglet "Aide" avec les informations nécessaires à la compréhension et la prise en main de l'application.
- 
...
Justifications : 
  - Les fichiers sources ont tous un nom explicite qui permet de comprendre le contenu sans avoir besoin d'ouvir le fichier mais les noms ne suivent parfois une règle de nommage différente (parfois snake case, parfois camel case).
  - Il y a eu 340 commits en tout dont 97 dans les 3 derniers jours, chaque commit est expliqué et compréhensible. 
  - Julien Gossa figure comme "owner" dans la liste des membres et le dépôt GIT est en Interne (il est donc accessible à tous).
...
Résumer en une phrase ce que vous avez éventuellement appris : Je ne savais pas que les Visual Novels utilisent (peuvent utiliser) un système d'arbre pour gérer les rapports entre personnages et qu'on pouvait télécharger les modèles d'IA afin de pouvoir les utiliser sans avoir besoin d'être connecté à internet.

Autres justifications : 
  - Il faut suivre les instructions (environ 4-5 en fonction du mode d'installation et du système de l'utilisateur) pour installer le prototype.
  - L'application se lance en cliquant sur l'exécutable AppLauncher.bat. 
  - L'application manque cruellement d'explications.
...
## Résultat T4
- Total d'item « Excellent » (2 point) : 8
