...
- Proposition 1 : Ajout d’une base de cohérence narrative les éléments générés (personnages, scènes, dialogues) seront reliés par une base de données
- Proposition 2 : Ajout d’un système de profils utilisateurs L’application proposera plusieurs profils d’utilisation afin d’adapter l’interface et les options disponibles selon le niveau

# Propositions d'amélioration du jeu

- Proposition 1 : ameliore le graphique
- Proposition 2 : avoir plus de fluidite
...
- Implication
  ...
  **Commentaire :** *Utilisation de ChatGPT pour nous évaluer*
...
Justifications :
Julien Gossa est owner du dépôt Git, ce qui assure un bon contrôle administratif. Le dépôt est accessible à tous les membres pour garantir une collaboration fluide.
On fait des commits régulièrement, en lien avec chaque tâche. Les messages sont toujours clairs et bien remplis pour qu’on comprenne facilement ce qui a été fait.
Tous les fichiers sources sont partagés dans un espace commun avec une structure de dossiers claire. Leur nommage est cohérent et facilite la lecture et la maintenance du projet.
...
Résumer en une phrase ce que vous avez éventuellement appris : c est un logiciel de generation de scenario
