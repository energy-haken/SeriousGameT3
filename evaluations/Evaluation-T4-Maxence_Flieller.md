...
- Explication de l'utilitée du wiki
- Explication plus détaillé des fonctionnalités et des fonctionnalités avancés.
- - explication de l'instalation plus simple, et meilleurs explications des condition nécéssaire au lancement(processeur, os)

# Propositions d'amélioration du jeu

- une fenetre pour expliquer les différentes manipulations possible.
- meilleurs portabilité
- Renomer les bouton Bob car le nom n'evoque pas la fonction.
- meilleur organisation de l'espace de la page, certainsespace sont vides et d'autres tres compacts
- le concept de generation par ia est intéressant  et devrait etre expliquer dans le jeux, car cela est l'interet principal de celui ci.
...
Justifications :Le titre des commits sont calaires, l'accès au fichiers est simple, des expliction sur l'arboréssence des fichiers etais nécéssaire.
...
Autres justifications : Je n'ai pas pue installé le jeu sous linux, le jeux ne marche pas avec certains processeur, le jeux est assez difficile a prendre en main et il manque un tutoriel.
