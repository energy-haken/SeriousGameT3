...
- Plus insister sur le fait que c'est un projet sur le long terme 
- Décrire plus les fonctionnalités (fonctionnement, utilité)
- Plus développer chaque parties, même si elles sont compréhensibles, une plus grand développement permettrait de mieux faire la passation du projet pour nous l'année prochaine
- Une clarification des objectifs pédagogiques, pas forcément un problème du groupe mais peut-être du sujet 
-Développer le fonctionnement de l'appli, le lien entre l'appli et ren'py
- Quelques points sont développés dans le wiki donc il faut juste regarder le wiki

# Propositions d'amélioration du jeu

- Un tuto pour mieux comprendre chaques fonctionnalités/boutons du projet car on peut vite être perdu
- Le projet reste utilisable, le tuto serait vraiment un boost pour mieux le comprendre et l'utilisé à son plein potentiel
- Le projet est sympa et le principe de transfère d'année en année est cool 
...
Résumer en une phrase ce que vous avez éventuellement appris : faire de la génération IA en local 

Autres justifications : Le projet est sympa, il manque juste des instructions plus clairs lors de la génération 
